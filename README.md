...
v1.3.1のインストーラー: `Life-Launcher-v1.3.1-windows-x64-setup.exe`

### Standalone EXE

インストールせず直接起動できます。

v1.3.1の単体実行版: `Life-Launcher-v1.3.1-windows-x64.exe`

### Portable ZIP

ZIPを展開して利用できます。

v1.3.1のZIP版: `Life-Launcher-v1.3.1-windows-x64-portable.zip`
