...
export const HELP_GUIDE_SECTIONS: HelpGuideSection[] = [
    ...
    blocks: [
      {
        type: "steps",
        items: [
          "「＋ プロジェクト」から、続けたいテーマを1つ作ります。最初は「英語」「読書」「運動」のような短い名前で十分です。",
    ...
    blocks: [
      {
        ...
        items: [
          {
            term: "プロジェクト",
            description: "続けたいテーマです。例: 読書。",
          },
          {
            term: "次の一手",
            description: "そのプロジェクトで迷ったときに戻る行動を1つだけ置きます。例: 本を10ページ読む。",
          },
          {
            term: "やりたいこと",
            description: "次の一手以外の候補置き場です。例: 図書館で借りる本を探す、感想をメモする。",
          },
          {
            term: "今日の3件",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "今日の3件はドラッグで並べ替えられ、下の解除エリアへ動かすと今日の選択だけを外せます。Timer実行中・一時停止中は先にTimerを終了してください。完了するか今日から外すと、元の次の一手・やりたいことを再び変更できます。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "paragraph",
        text: "次の一手・やりたいことの「開始環境を選ぶ」では、アプリ、フォルダ、ファイル、URLを最大2件まで選べます。Timerを始めると、選んだものを順番に開きます。",
      },
      {
        type: "paragraph",
        text: "手順書ビューアーにはMarkdown・Text・HTMLをまとめたローカルフォルダを登録できます。MarkdownとTextは編集でき、HTMLは表示専用です。次の一手で「開始時に開く」を有効にすると、Timerと同時に表示します。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "paragraph",
        text: "設定の「バックアップ」で保存先を選ぶと、設定と実行記録をZIPへ保存できます。「ZIPから復元」ではバックアップ時点へ戻し、復元前の現在データも内部バックアップへ退避します。",
      },
      {
        type: "paragraph",
        text: "ソフトウェアリセットは設定と記録を初回状態へ戻します。登録元のアプリ、ファイル、フォルダ、手順書本体、既存バックアップは削除しません。",
      },
      {
        type: "note",
        tone: "warning",
