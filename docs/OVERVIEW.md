...
> 最終更新: 2026-09-16 / Phase 8.4実装完了（未リリース）
...
| Version  | 概要                                                                                                                                                               |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v1.3候補 | Phase 8〜8.4でProject/NextStep/Wishlist、config v3移行、計測Timer、Settings、ソフトウェアリセット、Today Picker、Today3解除Drop Zone、Do Now順位を更新。未リリース |
