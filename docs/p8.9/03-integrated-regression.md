...
- P8.9 targeted visual/settings/responsive/large-and-xlarge D&D tests: 22 passed, including Main toolbar scaling and Records isolation. across 620/860/1080/1440/1920 widths and all three presets.
...
- 1920px standard/large/xlarge screenshots inspected. Standard retains prior density; larger presets use broader Main width. After user review feedback, the Main top menu also grows at wide widths, while Sidebar and the Records toolbar remain unchanged. The initially wrapped xlarge Today3 heading was corrected.
